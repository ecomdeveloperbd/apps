...
Map<String, dynamic> environment = {
  "appConfig": "https://raw.githubusercontent.com/ecomdeveloperbd/apps/main/demo_prodigitalstore.json",
  //"appConfig": "lib/config/config_en.json",

  /// ➡️ lib/common/config.dart
  "serverConfig": {
    'type': 'woo',
    'url': 'https://pharmacy.gulshancityspa.com',
    'consumerKey': 'ck_31c6617edb7ed7756eb85015338b0102b5c03589',
    'consumerSecret': 'cs_909dfb77a46b27632199246e418274574f78ccb3',
    'blog': 'https://pharmacy.gulshancityspa.com',
    //Your website woocommerce. You can remove this line if it same url
    /// remove to use as native screen
    'forgetPassword': 'http://ecommercedemo.prodigitalstore.xyz/wp-login.php?action=lostpassword'
  },
